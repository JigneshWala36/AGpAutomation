...
public class CommercialConsumerRegistration1 extends TestBase {

    // Initializing the PageObject

    public CommercialConsumerRegistration1() {
...
//    Xls_Reader reader = new Xls_Reader(System.getProperty("user.dir") + "\\src\\main\\java\\com\\excel\\qa\\testdata\\TestData.xlsx");
    ...
    public void fetchDataFromExcelForNewCommercialRegistration1() throws InterruptedException {
